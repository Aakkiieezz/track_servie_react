	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				...
				const sortedMovies = response.data.movies.sort((a: FreqData, b: FreqData) => b.value - a.value);
				const sortedTVShows = response.data.tvShows.sort((a: FreqData, b: FreqData) => b.value - a.value);
