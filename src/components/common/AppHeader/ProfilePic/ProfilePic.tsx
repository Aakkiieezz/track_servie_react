        ...
        <div className={styles.profilePicContainer}>
            ...
            <div className="dropdown">
                ...
                <ul className={`dropdown-menu ${AppHeaderStyles.dropdownMenu} ${styles.dropdownMenu}`}>
                    <li>
                        <button className={AppHeaderStyles.dropdownItem} type="button" onClick={() => navigate("/profile/me/overview")}>
                            <i className="bi bi-person-circle"></i> Profile
                        </button>
                    </li>
                    <li>
                        <button className={AppHeaderStyles.dropdownItem} type="button" onClick={() => navigate("/profile/me/servies")}>
                            <i className="bi bi-film"></i> Servies
                        </button>
                    </li>
                    <li>
                        <button className={AppHeaderStyles.dropdownItem} type="button" onClick={() => navigate("/profile/me/lists")}>
                            <i className="bi bi-list"></i> Lists
                        </button>
                    </li>
                    <li>
                        <button className={AppHeaderStyles.dropdownItem} type="button" onClick={() => navigate("/profile/me/watchlist")}>
                            <i className="bi bi-clock-fill"></i> Watchlist
                        </button>
                    </li>
                    <li>
                        <button className={AppHeaderStyles.dropdownItem} type="button" onClick={() => navigate("/profile/me/network")}>
